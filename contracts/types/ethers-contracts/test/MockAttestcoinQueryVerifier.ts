...
decodeFunctionResult(functionFragment: 'verify', data: BytesLike): Result;
  ...
  export interface MockAttestcoinQueryVerifier extends BaseContract {
    
    connect(runner?: ContractRunner | null): MockAttestcoinQueryVerifier;
    waitForDeployment(): Promise<this>;

    interface: MockAttestcoinQueryVerifierInterface;
  ...
  removeAllListeners<TCEvent extends TypedContractEvent>(event?: TCEvent): Promise<this>
    ...
    calculateTxIndex: TypedContractMethod<
      [arg0: IAttestcoinQueryVerifier.MerkleProofStruct, ],
      [bigint],
      'view'
    >
